        ...
        insertCss = function(){
            if(!window.slimScrollStylesApplied){
                ...
                var slim = "["+l+"]",
                    ...
                    S = pA+";top:0px"+imp+";bottom:0px"+imp+";right:0px;left:auto;width:8px;cursor:pointer"+imp+";padding-right:0px"+imp+";",
                    s = pA+";background-color:#999;top:0px;left:0px;right:0px;height:8px"+imp+";",
                    //creating a sheet
